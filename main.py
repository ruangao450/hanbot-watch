...
def send_to_discord_embed(description, filename, message_link):
    try:
        embed_data = {
          "embeds": [{
            "title": "🛡️ Hanbot Version Watch (TEST)",
            "color": 3447003,
            "fields": [
              { "name": "✅ Status: New Version Detected", "value": "This is a test message processing the last available update.", "inline": False },
          ...
          "components": [
            { "type": 1, "components": [ { "type": 2, "label": "Download from Telegram", "style": 5, "url": message_link } ] }
          ]
        }
